---
title: "호무라 히메(Homura Hime) 한글 번역"
slug: "homura-hime-korean-translation"
description: "Homura Hime 한글 번역 파일과 적용 방법을 정리합니다."
...
![안과 히메가 앉아 있는 장면](./images/hime_ann-and-hime.png)

<section class="game-meta" aria-label="Homura Hime 게임 정보">
  <div class="game-meta__head">
    <span>Game Data</span>
  </div>
  <dl>
    <div>
...
![Steam에서 Homura Hime 로컬 파일 폴더를 여는 화면](./images/hime_steam-local-file.png)
...
![Homura Hime 메인 화면에서 설정 메뉴를 선택하는 화면](./images/hime_setting-0.png)

설치가 끝났다면 게임을 실행하고 메인 화면에서 설정 메뉴로 들어갑니다.

![Homura Hime 설정 화면에서 언어를 일본어로 선택하는 화면](./images/hime_setting-1.png)
